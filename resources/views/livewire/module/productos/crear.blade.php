<div class="content-row">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <div class="panel-title"><b>Crear Producto</b>
        </div>
      </div>
      ...
      <div class="panel-body">
        <div class="form-horizontal">
          <div class="form-group">
            ...
            <div class="col-md-10">
              <input type="text" placeholder="Producto" id="title" class="form-control" wire:model="producto">
            </div>
          </div>
          ...
          <div class="text-right form-group">
            <div class="col-md-offset-2 col-md-10">
              ...
              <button class="float-right btn btn-info" wire:click='storeProducto()'>Crear</button>
            </div>
          </div>
        </div>
      </div>
