...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <select name="" id="" wire:model="desde" class="form-control">
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <select name="" id="" wire:model="hasta" class="form-control">
...
<div class="float-right text-right">
    <button wire:click='iniciarMovimiento()' class="float-right btn btn-danger"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Iniciar</button>
</div>
@endif
